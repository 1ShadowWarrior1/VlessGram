...
public class ApplicationLoader extends Application {
    ...
    public static void postInitApplication() {
        ...
        // VLESS: connect first (top priority), then refresh subscriptions in background.
        // Ping check is disabled on startup - user must press "Check Ping" button manually.
        VlessRepository vless = VlessRepository.getInstance();
        vless.ensureAutoConnect();
        // vless.checkPingAllAsync(); // Disabled - user must press button
        // Refresh subscriptions after a short delay to ensure network is ready
        vless.refreshAllSubscriptionsAsyncDelayed();
    }
    ...
    public static void startPushService() {
        // Всегда включено - запускаем сервис независимо от настроек
        try {
